...
$fatpacked{"perl/5.30.0/JSON/XS.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL_5.30.0_JSON_XS';
  =head1 NAME
...
$fatpacked{"perl/5.30.0/JSON/XS/Boolean.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL_5.30.0_JSON_XS_BOOLEAN';
  =head1 NAME
...
$fatpacked{"perl/5.30.0/common/sense.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'PERL_5.30.0_COMMON_SENSE';
